<script lang="ts">
	...
	// import '$lib/styles/legal.scss';
</script>

<main class="page">
	<section class="clean-block clean-form dark my-5">
		<div class="container mx-auto m-4">
			<div class="block-heading text-center m-5">
				<h1 class="text-info">Terms and Conditions</h1>
				<p>Last updated: March 17, 2022</p>
			</div>
			<div id="applyLegalCSS" class="block-content">
				...
				<ul>
					...
					<li>
						<p>
							...
							Agreement) refers to Land Listing Pro, 7602 Auden Trail, Atlanta, GA 30350.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Land Listing Pro, accessible from
							<a href="/" rel="external nofollow noopener" target="_blank">{$page.url.origin}</a>
						</p>
					</li>
					<li>
						<p>
				...
				<p>
					...
					name, Your email, Your phone number, Your credit card number, the expiration date of Your
				...
				<p>
					Your right to cancel an Order only applies to Goods that are returned in the same
					condition as You received them. You should also include all of the products instructions,
					documents and wrappings. Goods that are damaged or not in the same condition as You
					received them or which are worn simply beyond opening the original packaging will not be
					refunded. You should therefore take reasonable care of the purchased Goods while they are
					in Your possession.
				</p>
				<p>
				...
				<ul>
					...
					<li>
						...
						performance has begun with Your prior express consent and You have acknowledged Your
				...
				<p>
					...
					to change or update information and to correct errors, inaccuracies, or omissions at any
				...
				<p>
					...
					of our copyright agent via email at contact@landlistingpro.com and include in Your notice
				...
				<p>
					You can contact our copyright agent via email at contact@landlistingpro.com. Upon receipt
				...
				<ul>
					<li>
						<p>By email: contact@landlistingpro.com</p>
					</li>
					<li>
						<p>
							By visiting this page on our website: <a
								...
								target="_blank">{$page.url.origin + '/contact'}</a
							>
						</p>
					</li>
				</ul>

	...
	<section class="clean-block clean-form dark my-5">
		<div class="container mx-auto m-4">
			<div class="block-heading text-center m-5">
				<h1 class="text-info">Privacy Policy</h1>
			...
			<div id="applyLegalCSS" class="block-content">
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Land Listing Pro, 7602 Auden
							Trail, Atlanta, GA 30350.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							...
							to develop and implement a mechanism for allowing internet users to control the tracking
				...
				<p>
					...
					cookies here: <a
						...
						target="_blank"
						rel="noreferrer">Cookies by TermsFeed Generator</a
					>.
				</p>
				...
				<ul>
					<li>
						...
						<p>
							Matomo is a web analytics service. You can visit their Privacy Policy page here: <a
					...
					<li>
						...
						<p>
							...
							policy: <a
								...
								rel="external nofollow noopener noreferrer"
								target="_blank">https://mailchimp.com/legal/privacy/</a
							>
						</p>
					</li>
				</ul>
					...
					<li>
						<p>
							<strong
								...
								Records statute (Cal. Civ. Code § 1798.80(e)).</strong
							>
						</p>
						<p>
					...
					<li>
						<p>
							<strong
								...
								Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)).</strong
							>
						</p>
						<p>
				...
				<p>
					...
					We may have received some kind of benefit in return for sharing personal information, but
				...
				<ul>
					<li>
						...
						of Personal Data are being collected and the purposes for which the Personal Data is being
						used.
					</li>
					<li>
					...
					<li>
						<strong>The right to say no to the sale of Personal Data (opt-out).</strong> You have the
